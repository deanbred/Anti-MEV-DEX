...
/* var TradingView = function(e) {
  ...
  function t(e, i) {
      ...
      for (const o in i)
          "object" != typeof e[o] || null === e[o] || Array.isArray(e[o]) ? void 0 !== i[o] && (n[o] = i[o]) : n[o] = t(e[o], i[o]);
      return n
  }
  const i = {
      mobile: {
  ...
  const r = class {
      constructor(e) {
          ...
          if (this._options = t(n, e),
          e.preset) {
              const t = i[e.preset];
              t ? (void 0 !== this._options.disabled_features ? this._options.disabled_features = this._options.disabled_features.concat(t.disabled_features) : this._options.disabled_features = t.disabled_features,
              void 0 !== this._options.enabled_features ? this._options.enabled_features = this._options.enabled_features.concat(t.enabled_features) : this._options.enabled_features = t.enabled_features) : console.warn("Unknown preset: `" + e.preset + "`")
          }
          "Dark" === this._options.theme && void 0 === this._options.loading_screen && (this._options.loading_screen = {
              backgroundColor: "#131722"
          }),
          this._options.debug && (o || (o = !0,
          console.log("Using CL v21.066 (internal id 132c7060 @ 2022-04-01T09:59:44.647Z)"))),
          this._create()
      }
      onChartReady(e) {
      ...
      _create() {
          ...
          i.innerHTML = e,
          this._iFrame = i.querySelector(`#${this._id}`);
          ...
          this._innerWindowLoaded = new Promise((e=>{
              const t = ()=>{
                  n.removeEventListener("load", t, !1),
                  e()
              }
              ;
