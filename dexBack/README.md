...
PROMPT: I am coding a decentralized exchange that uses 0x protocol API to swap tokens on Ethereum, Polygon, Arbitrum, and Optimism. I have a multiChainTokenList.json file.

In this Modal I need to load the correct token information depending on which network the user is connected to. How can I do this?```
        ...
        <div className="modalContent">
          {tokenList?.map((e, i) => {
            return (
              ...
              >
                <img src={e.logoURI} alt={e.ticker} className="tokenLogo" />
...
I am using React and wgami hooks to build the front end. The Swap.jsx component delimited by triple backticks is the main component that handles the swap. In the executeSwap function
